...
/// <summary>
/// Single DbContext for the whole schema.
/// Files are organized by module, but EF mapping is centralized.
/// </summary>
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder b)
    {
        ...
        b.Entity<Rental>(e =>
        {
            ...
            // Rental 1-1 RentalReport (RentalReport has FK rental_id)
        ...
        b.Entity<RentalReport>(e =>
        {
            e.HasKey(x => x.Id);
            e.HasIndex(x => x.Uuid).IsUnique();
            e.HasIndex(x => x.RentalId).IsUnique(); // one-to-one
